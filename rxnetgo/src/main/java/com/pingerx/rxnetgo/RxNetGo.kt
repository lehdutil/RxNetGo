...
class RxNetGo {
     ...
     * 获取全局公共请求参数
     */
    fun getCommonParams(baseUrl: String): HttpParams? {
        return mParamsMap[baseUrl]
    }

    /**
     * 获取全局公共请求头
     */
    fun getCommonHeaders(baseUrl: String): HttpHeaders? {
        return mHeadersMap[baseUrl]
    }
     ...
     */
    fun addCommonParams(baseUrl: String, params: HttpParams): RxNetGo {
        mParamsMap[baseUrl] = params
        return this
    }
     ...
     */
    fun addCommonHeaders(baseUrl: String, headers: HttpHeaders): RxNetGo {
        mHeadersMap[baseUrl] = headers
        return this
    }
