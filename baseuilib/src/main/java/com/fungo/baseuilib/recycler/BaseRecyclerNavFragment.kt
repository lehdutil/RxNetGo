 ...
 */
abstract class BaseRecyclerNavFragment : BaseNavFragment(), BaseRecyclerContract.View {
    ...
    final override fun initContentView() {
        ...
        mRecyclerView?.isVerticalScrollBarEnabled = isVerticalScrollBarEnabled()
        mRecyclerView?.isHorizontalScrollBarEnabled = isVerticalScrollBarEnabled()
